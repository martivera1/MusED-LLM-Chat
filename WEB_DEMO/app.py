...
# Ruta para manejar la subida de archivos y la conversión (ANTIC)
...
def upload_file():
    ...
    # Guardar el archivo XML en el directorio temporal
    filename = secure_filename(file.filename)
    input_path = os.path.join(TEMP_DIR, filename)
    file.save(input_path)

    try:
        # Convertir el archivo XML a ABC usando la función de conversión
